          ...
          <div className="flex flex-col items-center mt-5 xs:mt-6 sm:mt-12 md:mt-14 w-full px-2">
            ...
            <div className="flex items-center gap-2 sm:gap-3 mt-1.5 sm:mt-2 px-3 py-1.5 sm:px-5 sm:py-2.5 rounded-full bg-black/50 backdrop-blur-xl border border-white/20 shadow-[0_8px_32px_rgba(0,0,0,0.4)] max-w-full">
              ...
              <MagneticButton
                ...
                className="w-5 h-5 xs:w-7 xs:h-7 sm:w-8 sm:h-8 rounded-full bg-[#F5C86C] hover:bg-[#E4B553] text-[#0e161c] flex items-center justify-center shadow-[0_0_14px_rgba(245,200,108,0.4)] shrink-0"
              >
                {copied ? (
        ...
        <div className="relative z-10 w-full max-w-7xl mx-auto flex flex-col sm:flex-row justify-between items-center gap-2.5 sm:gap-0 pt-4 sm:pt-6 pb-2 text-xs sm:text-sm text-neutral-300">
          ...
          <div className="flex items-center gap-3 sm:gap-4">
            ...
            <MagneticButton
              ...
              rel="noreferrer"
              ariaLabel="GitHub"
              className="w-7 h-7 sm:w-8 sm:h-8 rounded-full bg-black/40 backdrop-blur-md border border-white/10 flex items-center justify-center hover:bg-[#F5C86C] hover:text-[#0e161c] hover:border-[#F5C86C] text-white shadow-xs"
            >
            ...
            <MagneticButton
              ...
              rel="noreferrer"
              ariaLabel="LinkedIn"
              className="w-8 h-8 rounded-full bg-black/40 backdrop-blur-md border border-white/10 flex items-center justify-center hover:bg-[#F5C86C] hover:text-[#0e161c] hover:border-[#F5C86C] text-white shadow-xs"
            >
